    ...
    .row.fondo1.align-items-center
      .col-lg-12.col-md-12.col-12.px-lg-5.px-4
        .row.justify-content-center.mb-4(data-aos="fade-down") 
          ...
          p.mb-4(data-aos="zoom-in-up") Teniendo en cuenta lo anterior, se hará un recorrido para lograr entender el cuerpo a partir de los siguientes conceptos en relación con la estructura corporal:
